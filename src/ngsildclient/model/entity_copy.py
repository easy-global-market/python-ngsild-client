...
class Entity:
    ...
    def update(self, fragment: Union[Fragment, dict]):
        """Create a NGSI-LD entity from a dictionary.
        ...
        Entity
            The result Entity instance
        """
        self._payload |= fragment._payload if isinstance(fragment, Fragment) else fragment
    ...
    def pprint(self, kv=False, *args, **kwargs):
        ...
        kv : bool, optional
            KeyValues format (aka simplified representation), by default False
        """
        globalsettings.f_print(self.to_json(kv, indent=2, *args, **kwargs))
