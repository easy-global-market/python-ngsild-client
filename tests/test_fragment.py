...
def test_set_1():
    e = Entity("Vehicle", "A4567").prop("brandName", "Mercedes")
    e.prop("speed", 55, datasetid="Property:speedometerA4567-speed").prop("source", "Speedometer", NESTED)
    e._set("brandName.value", "Peugeot")
    assert e["brandName"] == {"type": "Property", "value": "Peugeot"}
...
def test_set_2():
    ...
    e._set("speed[1].source.value", "Antenna")
    assert e["speed[1].source"] == {"type": "Property", "value": "Antenna"}
